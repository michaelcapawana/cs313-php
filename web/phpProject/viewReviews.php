...
try {
    ...
    //$num = 3;
    $stmt = $db->prepare('SELECT reviews.rating, reviews.user_id, reviews.description, reviews.business, business.business FROM reviews, business WHERE business=:business');
